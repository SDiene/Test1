...
<br>
<h3 align=center>Liste des étudiants Loger et boursier</h3>
    ...
    // Liste de tous les etudiants non boursiers 
    
    $list= new EtudiantServices();

    foreach ($list->findBL() as $val) {
